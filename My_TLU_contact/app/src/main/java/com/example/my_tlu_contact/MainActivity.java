   ...
   private String ROLE,ID,NAME,PHONE,ADDRESS,EMAIL,DATE;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = getIntent();
         ROLE = intent.getStringExtra("ROLE_");
         ID = intent.getStringExtra("USER_ID");
         NAME = intent.getStringExtra("USER_NAME");
         PHONE = intent.getStringExtra("USER_PHONE");
         ADDRESS = intent.getStringExtra("USER_ADDRESS");
         EMAIL = intent.getStringExtra("USER_EMAIL");
         DATE = intent.getStringExtra("USER_BIRTHDAY");

        Login_Activity.DataHolder.getInstance().setData(ROLE);
        ...
        crv_dv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myintent.putExtra("ROLE_MAIN", ROLE);
